package org.wuyang.train.generator.server;
...
import org.wuyang.train.generator.util.DbUtil;
import org.wuyang.train.generator.util.Field;
import org.wuyang.train.generator.util.FreemarkerUtil;
import java.io.File;
...
//        genVue(do_main, param);
    ...
    private static void genVue(String do_main, HashMap<String, Object> param) throws IOException, TemplateException {
        ...
        String filePathName = vuePath + "/" + do_main + ".vue";
