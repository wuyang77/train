package org.wuyang.train.${module}.resp;
...
public class ${Domain}QueryResp {
    ...
    */
    ...
    public String toString() {
        final StringBuffer sb = new StringBuffer("${Domain}QueryResp{");
        <#list fieldList as field>
        sb.append(", ${field.nameHump} =").append(${field.nameHump} )<#if field.javaType=='String'>.append('\'')</#if>;
        </#list>
        sb.append('}');
        return sb.toString();
    }
