package org.wuyang.train.business.resp;
...
public class DailyTrainTicketQueryResp {
    ...
    */
    ...
    public String toString() {
        final StringBuffer sb = new StringBuffer("DailyTrainTicketQueryResp{");
        sb.append(", id =").append(id );
        sb.append(", date =").append(date );
        sb.append(", trainCode =").append(trainCode ).append('\'');
        sb.append(", start =").append(start ).append('\'');
        sb.append(", startPinyin =").append(startPinyin ).append('\'');
        sb.append(", startTime =").append(startTime );
        sb.append(", startIndex =").append(startIndex );
        sb.append(", end =").append(end ).append('\'');
        sb.append(", endPinyin =").append(endPinyin ).append('\'');
